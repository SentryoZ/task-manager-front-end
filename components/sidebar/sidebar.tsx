...
const Sidebar = () => {
  ...
  return (
    <div className="md:w-60  h-screen flex-1 flex-col fixed border-r hidden md:flex p-4 dark:text-white">
        ...
        {SidebarItems.map((item, index) =>
          item.href ? (
            <Link href={item.href} key={index}>
              <div
                className={`flex items-center space-x-4 p-2 rounded-lg hover:bg-gray-200 transition-all duration-300 ease-in-out cursor-pointer dark:hover:bg-gray-600 ${
